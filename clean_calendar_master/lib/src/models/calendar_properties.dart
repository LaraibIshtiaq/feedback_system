...
class CalendarProperties {
  ...
  final Map<String, List<DateTime>>? datesForStreaks;
  ...
  /// Calendar current view callback.
  final Function moveToNextMonth;

  /// Calendar current view callback.
  final Function moveToPreviousMonth;
  ...
  CalendarProperties({
    ...
    Map<String, List<DateTime>>? datesForStreaks,
    ...
    required this.moveToNextMonth,
    required this.moveToPreviousMonth
  })  :
        ...
        streakDatesProperties = DatesProperties(
          ...
          datesDecorationBuilder: streakDatesProperties?.datesDecorationBuilder
        ),
        ...
        selectedRangeBetweenDatesProperties = DatesProperties(
          ...
          datesDecorationBuilder: selectedRangeBetweenDatesProperties?.datesDecorationBuilder ?? null
        ),
        ...
        datesForStreaks = datesForStreaks?.map(
              (key, list) => MapEntry(
            key,
            list.map((date) => DateTime.utc(date.year, date.month, date.day)).toList(),
          ),
        ),
